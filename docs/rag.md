...
# AI Tutor V2 - RAG Implementation Plan

## Overview

Implement RAG (Retrieval Augmented Generation) for educational content using Convex RAG component. This enables the AI tutor to answer questions using actual textbook content from grades 1-12 across Math, Physics, Biology, and other subjects.
